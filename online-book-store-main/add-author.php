...
<body>
	...
	<div class="container">
        ...
        <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            <form action="php/add-author.php" method="post" class="form-container">
                <h1 class="text-center pb-3">Add New Author</h1>
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-orange">Add Author</button>
                </div>
            </form>
        </div>
	</div>
