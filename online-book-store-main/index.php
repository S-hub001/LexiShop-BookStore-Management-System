	...
	<style>
        ...
        .list-group-custom .list-group-item:first-child {
			...
			outline: none !important; /* Removes blue outline */
  			border: none !important;  /* Ensures no border is causing the effect */
	...
	<div class="container">
		...
		<div class="d-flex pt-3">
			...
			<div class="pdf-list d-flex flex-wrap">
				...
				<div class="card m-1 card-custom">
				<img width="100" src="uploads/cover/<?=$book['cover']?>" class="card-img-top"> 
					<div class="card-body">
						<h5 class="card-title">
							<?=$book['title']?>
						</h5>
						<p class="card-text">
							...
							<br><i><b>Category:
								...
								<?php } ?>
							<br></b></i>
							<br><b>Price: $<?= number_format($book['price'], 2) ?></b>  <!-- This is the added price -->
						</p>
                       <a href="uploads/files<?=$book['file']?>"
						...
						<a href="add-to-cart.php?id=<?=$book['id']?>"
		...
		<div class="category">
			...
			<!-- List of authors -->
			<div class="list-group mt-5 list-group-custom">
				<?php if ($authors == 0){
					// do nothing
				}else{ ?>
				<a href="#"
